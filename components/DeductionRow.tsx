...
import { Card, XpBadge } from '@/components/ui'
...
export function DeductionRow({
  ...
  return (
    <li>
      <Card padding="md" className="flex items-start gap-3 border-danger-500/30 bg-danger-100/60">
        <span
          aria-hidden
        ...
        <div className="min-w-0 flex-1">
          <div className="flex flex-wrap items-start justify-between gap-2">
            <div className="min-w-0">
              <h4 className="text-base font-extrabold text-ink-900">หักคะแนน</h4>
          ...
          <p className="mt-2 rounded-xl bg-cream-50 px-3 py-2 text-sm font-semibold text-ink-900">
